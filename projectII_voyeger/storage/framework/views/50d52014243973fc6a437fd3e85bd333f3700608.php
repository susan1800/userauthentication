<style type="text/css">
        ...
        #gradient_bg{
            ...
            top: 61px;
            left: 0px;
            background-image: url(<?php echo e(voyager_asset('images/bg.jpg')); ?>);
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#b3111111', endColorstr='#b3111117',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */
    ...
    </style><?php /**PATH F:\laravel1\projectII_voyeger\vendor\tcg\voyager\src/../resources/views/compass/includes/styles.blade.php ENDPATH**/ ?>